...
Let's first describe the canonical probabilistic model of record linkage to demonstrate its properties. Materials are from the [original papaer](https://imai.fas.harvard.edu/research/files/linkage-app.pdf) and its [online supplementary](https://imai.fas.harvard.edu/research/files/linkage-app.pdf)
