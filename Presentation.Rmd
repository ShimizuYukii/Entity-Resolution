...
if (!file.exists("RS_data/over_match.png")) {
  dir.create(file.path('RS_data'), showWarnings = FALSE)
  download.file("https://raw.githubusercontent.com/ShimizuYukii/Entity-Resolution/main/RS%20data/over_match.png", 
...
if (!file.exists("RS_data/Picture2.png")) {
  download.file("https://raw.githubusercontent.com/ShimizuYukii/Entity-Resolution/main/RS%20data/Picture2.png", 
