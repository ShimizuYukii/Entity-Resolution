...
```{r, echo=FALSE}
knitr::include_graphics("https://raw.githubusercontent.com/ShimizuYukii/Entity-Resolution/main/RS%20data/over_match.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("https://raw.githubusercontent.com/ShimizuYukii/Entity-Resolution/main/RS%20data/Picture2.png")
```
